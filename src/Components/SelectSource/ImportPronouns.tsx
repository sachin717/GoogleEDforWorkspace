...
function ImportPronouns(props) {
  ...
  return (
    <div className={"CSVPanelMain"} id="pronouns"  style={{margin:"10px 0",display:"flex",flexDirection:"column",gap:"10px"}}>
      ...
      <div>
        ...
        <ul style={{margin:"15px 30px"}}>
          ...
          <li style={{whiteSpace:"nowrap"}}>{"Please don't add any commas or any other fields to avoid conflicts with commas of CSV file."}</li>
