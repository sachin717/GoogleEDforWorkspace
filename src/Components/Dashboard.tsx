...
const Dashboard = ({
  ...
  function calculateGenderDiversityRatio(employees) {
    ...
    const maleRatio = ((genderCount["Male"] || 0) / totalEmployees *100).toFixed(2);
    const femaleRatio = ((genderCount["Female"] || 0) / totalEmployees *100).toFixed(2);
      ...
      >
        <div style={containerStyle}>
          <div className="chartHeaders" style={{...itemStyle}}>
            <p>{sampleData ? "161" : searchBoxData?.length}</p>
            <p>
              {translation.Head ? translation.Headcount : "countHead "}
            </p>
          </div>
